...
describe('04-build-something routes', function () {
    ...
    it('should retrieve all user profiles when route is hit', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should update a user profile when route is hit', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(app)
    ...
    it('should delete a user profile when route is hit', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(app).delete('/api/v1/profiles/1')];
                case 1:
                    res = _a.sent();
                    expect(res.body).toEqual({
                        gif: expect.any(String),
