...
module.exports = /** @class */ (function () {
    ...
    Profile.insert = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, pool.query("INSERT INTO profiles (name, word, gif) VALUES ($1, $2, $3) RETURNING *", [name, word, gif])];
                    case 1:
                        rows = (_b.sent()).rows;
    ...
    Profile.update = function (id, _a) {
        var name = _a.name, word = _a.word, gif = _a.gif;
        return __awaiter(this, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, pool.query("UPDATE profiles SET name=$1, word=$2, gif=$3 WHERE id=$4 RETURNING *", [name, word, gif, id])];
                    case 1:
                        rows = (_b.sent()).rows;
                        return [2 /*return*/, new Profile(rows[0])];
                }
